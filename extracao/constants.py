...
# %% auto 0
__all__ = ['TIMEOUT', 'RELATORIO', 'ESTACAO', 'MALHA_IBGE', 'CHANNELS', 'IBGE_MUNICIPIOS', 'IBGE_POLIGONO', 'COLUNAS',
           'COLS_LICENCIAMENTO', 'AGG_LICENCIAMENTO', 'AGG_SMP', 'APP_ANALISE_PT', 'APP_ANALISE_EN', 'ESTADOS',
           'SIGLAS', 'BW', 'BW_MAP', 'DICT_SRD', 'PROJECTION_SRD', 'DICT_LICENCIAMENTO', 'PROJECTION_LICENCIAMENTO',
           'SQL_RADCOM', 'SQL_STEL', 'SQL_VALIDA_COORD', 'MONGO_TELECOM', 'MONGO_SRD', 'MONGO_SMP', 'REGEX_ESTADOS',
...
IBGE_MUNICIPIOS = Path(__file__).parent / "datasources" / "arquivos" / "municipios.csv"
IBGE_POLIGONO = (
