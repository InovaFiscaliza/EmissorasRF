...
from .format import _read_df, merge_on_frequency, parse_bw

getcontext().prec = 5
load_dotenv(find_dotenv())

# %% ../nbs/02_updates.ipynb 5
def connect_db(
