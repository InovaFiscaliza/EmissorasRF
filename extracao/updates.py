# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_updates.ipynb.
...
def split_designacao(df: pd.DataFrame)->pd.DataFrame:
    ...
    df["Designação_Emissão"] = df["Designação_Emissão"].str.replace(",", " ").str.strip().str.upper()
    ...
    df[["Largura_Emissão(kHz)", "Classe_Emissão"]] = df["Designação_Emissão"].apply(parse_bw).tolist()
